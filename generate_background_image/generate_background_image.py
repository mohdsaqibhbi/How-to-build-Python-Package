...
def generate_background_image(words, out, layout_color, width, height, step_size, bias):
...
if __name__ == '__main__':
    ...
    generate_background_image(args["word_string"], args["out"], args["layout_color"],args["width"], args["height"],
